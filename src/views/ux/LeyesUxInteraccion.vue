<template>
  <div class="lh-lg">
    ...
    <p>
      Estas leyes no sustituyen a la accesibilidad ni a la validación con usuarios reales, pero sí
      ofrecen un marco muy útil para diseñar interfaces más comprensibles, eficientes y previsibles.
    </p>
  </div>
</template>
