<template>
  <div class="lh-lg">
    ...
    <p>
      Usar todas las técnicas y herramientas es muy complicado, a no ser que seamos corporaciones
      muy grandes con equipos específicos. Por ejemplo, en empresas como Spotify hay equipos de
      decenas de personas solo para estudiar la mejor ubicación de botones, la mejor forma de crear
      un formulario o simular perfiles de personas para mejorar el proceso de suscripción a su
      servicio.
    </p>
  </div>
</template>
