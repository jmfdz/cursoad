<template>
  <div>
    ...
    <ul>
      ...
      <li>Revisar el orden de lectura de los cuadros de texto, imágenes y demás objetos.</li>
      <li>Añadir texto alternativo a las imágenes, gráficos y diagramas que aporten información; los objetos decorativos se pueden marcar como tales.</li>
      <li>Mantener contraste suficiente y no transmitir la información únicamente con el color.</li>
    ...
    <figure class="my-4">
      <img
        ...
        alt="Opción para comprobar la accesibilidad en PowerPoint."
      />
    </figure>
    <figure class="my-4">
      <img
