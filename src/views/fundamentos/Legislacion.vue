<template>
  <div>
    ...
    <h2>Convención internacional de la ONU</h2>
    <p>
    ...
    <h2>Directiva (UE) 2016/2102 y Real Decreto 1112/2018</h2>
    <p>
      En el ámbito público, la referencia central es la Directiva (UE) 2016/2102, trasladada al
    ...
    <p>
      El estándar técnico europeo de referencia es la EN 301 549, que recoge requisitos de
    ...
    <ul>
      ...
      <li><a href="https://www.etsi.org/human-factors-accessibility/en-301-549-v3-the-harmonized-european-standard-for-ict-accessibility" target="_blank" rel="noreferrer">ETSI: EN 301 549 (Inglés)</a></li>
    </ul>
  </div>
</template>
