...
<template>
  <div class="row justify-content-center">
    <div class="col-12 col-lg-8 resultados-busqueda">
      ...
      <ul v-if="consulta && estado === 'listo' && resultados.length" class="list-unstyled">
...
<style scoped>
.resultados-busqueda { overflow-wrap: anywhere; }
</style>
