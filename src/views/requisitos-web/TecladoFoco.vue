<template>
  <div class="lh-lg">
    ...
    <p>
      ...
      `span` u otros elementos de maquetación para simular su comportamiento.
    </p>
    <p>
    ...
    <p>
      En definitiva, si una funcionalidad no puede utilizarse correctamente con teclado, no puede
