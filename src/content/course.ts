...
export const courseBlocks: Block[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        "html": "<h2 class=\"mt-4 mb-3\">Qué son las WCAG</h2>\n<p>Las WCAG (<i>Web Content Accessibility Guidelines</i>) son las pautas del W3C para hacer accesible el contenido web. No son una guía de estilo ni una colección de consejos sueltos, sino el marco técnico que se utiliza para revisar si un contenido digital es accesible.</p>\n<p>Aunque nacieron para la web, hoy se toman también como referencia para documentos, aplicaciones y otros productos digitales.</p>\n<h2 class=\"mt-4 mb-3\">Versiones</h2>\n<ul>\n<li><b>WCAG 1.0</b>: publicada en 1999. Fue la primera versión y se organizaba de otra manera distinta a la actual.</li>\n<li><b>WCAG 2.0</b>: publicada en 2008. Introdujo la estructura basada en principios, pautas y criterios de conformidad.</li>\n<li><b>WCAG 2.1</b>: publicada en 2018. Amplió requisitos, sobre todo en móvil, baja visión y aspectos cognitivos.</li>\n<li><b>WCAG 2.2</b>: publicada en 2023. Es la versión más reciente y la que tomamos como referencia en este curso.</li>\n</ul>\n<p>Para no liar conceptos, a partir de aquí hablaremos siempre de <b>WCAG 2.2</b>.</p>\n<h2 class=\"mt-4 mb-3\">Los cuatro principios</h2>\n<p>Las WCAG 2.2 se apoyan en cuatro principios fundamentales:</p>\n<ul>\n<li><b>Perceptible</b>: la información debe poder percibirse por distintos medios o sentidos. Por ejemplo, una imagen informativa necesita texto alternativo y un vídeo puede necesitar subtítulos.</li>\n<li><b>Operable</b>: la interfaz debe poder manejarse. Por ejemplo, una página debe poder usarse con teclado y no solo con ratón.</li>\n<li><b>Comprensible</b>: el contenido y el funcionamiento deben resultar entendibles y previsibles. Por ejemplo, los formularios deben estar bien etiquetados y los errores deben explicarse con claridad.</li>\n<li><b>Robusto</b>: el contenido debe estar bien construido para que navegadores y tecnologías de apoyo puedan interpretarlo correctamente.</li>\n</ul>\n<p>Este esquema suele resumirse como <b>POUR</b> y es útil porque ayuda a entender de dónde sale cada requisito técnico.</p>\n<h2 class=\"mt-4 mb-3\">Pautas</h2>\n<p>Dentro de esos cuatro principios, WCAG 2.2 agrupa <b>13 pautas</b>. Son una especie de grandes bloques temáticos. Vistas por principio, quedarían así:</p>\n<ul>\n<li><b>Perceptible</b>:</li>\n<li>1.1 Alternativas textuales.</li>\n<li>1.2 Medios basados en el tiempo.</li>\n<li>1.3 Adaptable.</li>\n<li>1.4 Distinguible.</li>\n</ul>\n<ul>\n<li><b>Operable</b>:</li>\n<li>2.1 Accesible por teclado.</li>\n<li>2.2 Tiempo suficiente.</li>\n<li>2.3 Convulsiones y reacciones físicas.</li>\n<li>2.4 Navegable.</li>\n<li>2.5 Modalidades de entrada.</li>\n</ul>\n<ul>\n<li><b>Comprensible</b>:</li>\n<li>3.1 Legible.</li>\n<li>3.2 Predecible.</li>\n<li>3.3 Asistencia en la entrada de datos.</li>\n</ul>\n<ul>\n<li><b>Robusto</b>:</li>\n<li>4.1 Compatible.</li>\n</ul>\n<p>Las pautas orientan sobre lo que hay que cuidar, pero todavía no son lo que se verifica de forma directa.</p>\n<h2 class=\"mt-4 mb-3\">Criterios de conformidad</h2>\n<p>Lo que realmente se comprueba para determinar si una web cumple WCAG son los <b>criterios de conformidad</b>. Actualmente, en WCAG 2.2 hay <b>86 criterios</b>.</p>\n<p>Cada criterio pertenece a una pauta concreta y tiene asignado un nivel de conformidad:</p>\n<ul>\n<li><b>A</b>: nivel mínimo imprescindible.</li>\n<li><b>AA</b>: nivel normalmente exigido.</li>\n<li><b>AAA</b>: nivel más alto, útil como mejora, pero difícil de aplicar en todos los casos.</li>\n</ul>\n<p>Un ejemplo sencillo:</p>\n<ul>\n<li>Principio: <b>Perceptible</b>.</li>\n<li>Pauta: <b>1.1 Alternativas textuales</b>.</li>\n<li>Criterio: <b>1.1.1 Contenido no textual</b>.</li>\n<li>Nivel: <b>A</b>.</li>\n</ul>\n<p>Ese criterio significa, simplificando mucho, que si una imagen transmite información debe tener una alternativa textual equivalente. Si la imagen es decorativa, no necesita esa misma descripción.</p>\n<p>Esto ayuda a entender la jerarquía:</p>\n<ul>\n<li>el principio marca una idea general,</li>\n<li>la pauta agrupa un tema,</li>\n<li>y el criterio define exactamente qué hay que cumplir.</li>\n</ul>\n<p>Cuando se dice que una web cumple <b>nivel AA</b>, lo que significa es que cumple todos los criterios de nivel A y AA que le sean aplicables.</p>\n<h3 class=\"mt-4 mb-3\">Referencias</h3>\n<ul>\n<li><a href=\"https://www.w3.org/WAI/standards-guidelines/wcag/\" target=\"_blank\" rel=\"noreferrer\">W3C: WCAG 2 Overview</a></li>\n<li><a href=\"https://www.w3.org/WAI/WCAG22/quickref/\" target=\"_blank\" rel=\"noreferrer\">W3C: How to Meet WCAG 2.2</a></li>\n<li><a href=\"https://www.w3.org/WAI/WCAG22/Understanding/intro\" target=\"_blank\" rel=\"noreferrer\">W3C: Introduction to Understanding WCAG 2.2</a></li>\n<li><a href=\"https://www.w3.org/WAI/intro/wcag10.html\" target=\"_blank\" rel=\"noreferrer\">W3C: WCAG 1.0</a></li>\n</ul>"
      },
      {
        "id": "legislacion",
