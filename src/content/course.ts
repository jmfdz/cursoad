...
export const courseBlocks: Block[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        "html": "<h2 class=\"mt-4 mb-3\">Qué son las WCAG</h2>\n<p>Las WCAG (<i>Web Content Accessibility Guidelines</i>) son las pautas del W3C para hacer accesible el contenido web. No son una guía de estilo ni una colección de consejos aislados, sino un marco técnico de referencia para revisar si un contenido puede percibirse, manejarse, entenderse y funcionar correctamente con tecnologías de apoyo.</p>\n<p>Aunque nacieron para la web, hoy se utilizan también como base para documentos, aplicaciones y otros productos digitales porque describen requisitos bastante estables y poco dependientes de una tecnología concreta.</p>\n<h2 class=\"mt-4 mb-3\">Cómo han evolucionado</h2>\n<p>La evolución de WCAG ayuda a entender por qué a veces se mezclan conceptos de versiones distintas:</p>\n<ul>\n<li><b>WCAG 1.0</b> se publicó el 5 de mayo de 1999. Tenía 14 pautas y 65 checkpoints, organizados por prioridades 1, 2 y 3.</li>\n<li><b>WCAG 2.0</b> se publicó el 11 de diciembre de 2008. Reorganizó el estándar en principios, pautas y criterios de conformidad.</li>\n<li><b>WCAG 2.1</b> se publicó el 5 de junio de 2018. Añadió 17 criterios nuevos, sobre todo en móvil, baja visión y aspectos cognitivos.</li>\n<li><b>WCAG 2.2</b> se publicó el 5 de octubre de 2023. Añadió 9 criterios nuevos orientados principalmente a mejorar la interacción.</li>\n</ul>\n<p>Por eso es fácil confundir los 65 checkpoints de WCAG 1.0 con los criterios de WCAG 2.x. Son estructuras distintas.</p>\n<h2 class=\"mt-4 mb-3\">Cómo se estructuran las WCAG 2</h2>\n<p>En las WCAG 2 la estructura se organiza por capas:</p>\n<ul>\n<li><b>4 principios</b>: Perceptible, Operable, Comprensible y Robusto.</li>\n<li><b>13 pautas</b>: desarrollan esos principios.</li>\n<li><b>Criterios de conformidad</b>: indican exactamente qué debe cumplirse.</li>\n<li><b>Niveles A, AA y AAA</b>: se asignan a cada criterio, no a cada principio ni a cada pauta.</li>\n</ul>\n<p>Esto es importante porque, aunque solemos decir que una web cumple o no cumple las WCAG, en realidad el cumplimiento se determina a partir de los <b>criterios de conformidad</b>.</p>\n<h2 class=\"mt-4 mb-3\">Los cuatro principios</h2>\n<ul>\n<li><b>Perceptible</b>: la información y los componentes de interfaz deben poder percibirse.</li>\n<li><b>Operable</b>: la interfaz debe poder manejarse, por ejemplo con teclado y sin barreras de interacción.</li>\n<li><b>Comprensible</b>: tanto el contenido como el funcionamiento deben resultar entendibles y previsibles.</li>\n<li><b>Robusto</b>: el contenido debe estar construido de forma compatible con navegadores y tecnologías de apoyo.</li>\n</ul>\n<p>Este esquema suele resumirse como <b>POUR</b> y es útil porque ayuda a entender de dónde sale cada requisito técnico que veremos después en el curso.</p>\n<h2 class=\"mt-4 mb-3\">Pautas, criterios y niveles</h2>\n<p>La relación entre estos elementos puede resumirse así:</p>\n<ul>\n<li>El <b>principio</b> marca una idea general. Ejemplo: el contenido debe ser perceptible.</li>\n<li>La <b>pauta</b> concreta una línea de trabajo dentro de ese principio. Ejemplo: ofrecer alternativas textuales.</li>\n<li>El <b>criterio de conformidad</b> define una condición verificable. Ejemplo: que el contenido no textual tenga una alternativa textual equivalente.</li>\n<li>El <b>nivel</b> indica la exigencia de ese criterio: A, AA o AAA.</li>\n</ul>\n<p>Una forma simple de verlo es esta:</p>\n<ul>\n<li>Principio: <b>Perceptible</b></li>\n<li>Pauta: <b>1.1 Alternativas textuales</b></li>\n<li>Criterio: <b>1.1.1 Contenido no textual</b></li>\n<li>Nivel del criterio: <b>A</b></li>\n</ul>\n<p>Ese criterio 1.1.1 significa, simplificando mucho, que si una imagen transmite información debe tener una alternativa textual. Si una imagen es decorativa, no necesita la misma descripción.</p>\n<p>Este ejemplo es útil porque deja clara la jerarquía:</p>\n<ul>\n<li>el principio orienta,</li>\n<li>la pauta agrupa,</li>\n<li>el criterio obliga,</li>\n<li>y el nivel marca el grado de exigencia.</li>\n</ul>\n<h2 class=\"mt-4 mb-3\">Cuántas pautas y cuántos criterios hay</h2>\n<ul>\n<li>WCAG 2.0 tiene <b>12 pautas</b>.</li>\n<li>WCAG 2.1 añade <b>1 pauta</b> nueva, por eso WCAG 2.1 y 2.2 tienen <b>13 pautas</b>.</li>\n<li>WCAG 2.1 añade <b>17 criterios</b> a WCAG 2.0.</li>\n<li>WCAG 2.2 añade <b>9 criterios</b> más, y además deja obsoleto el criterio <b>4.1.1 Parsing</b>.</li>\n</ul>\n<p>A partir de esos datos oficiales del W3C, se puede deducir que WCAG 2.2 contiene <b>86 criterios de conformidad</b>. Lo indico como cuenta derivada de las versiones publicadas: 61 en WCAG 2.0, 17 añadidos en 2.1, 9 añadidos en 2.2 y 1 retirado en 2.2.</p>\n<h2 class=\"mt-4 mb-3\">Qué significan los niveles A, AA y AAA</h2>\n<ul>\n<li><b>Nivel A</b>: requisitos imprescindibles para que no existan barreras graves de acceso.</li>\n<li><b>Nivel AA</b>: nivel normalmente exigido porque permite un acceso y un uso razonablemente accesibles.</li>\n<li><b>Nivel AAA</b>: nivel más alto, útil como objetivo de mejora, pero difícil de cumplir de forma completa en todos los contenidos.</li>\n</ul>\n<p>Cuando se exige nivel AA, eso significa cumplir todos los criterios de nivel A y todos los de nivel AA que sean aplicables.</p>\n<h2 class=\"mt-4 mb-3\">Qué conviene retener</h2>\n<p>Más que memorizar todos los criterios, interesa quedarse con la lógica que hay detrás:</p>\n<ul>\n<li>si una imagen transmite información, necesita alternativa textual,</li>\n<li>si una tarea puede hacerse con ratón, debe poder hacerse también con teclado,</li>\n<li>si una interfaz cambia, debe anunciarlo o dejarlo claro,</li>\n<li>y si el contenido está mal estructurado o mal etiquetado, los productos de apoyo no podrán interpretarlo correctamente.</li>\n</ul>\n<p>Como veremos a lo largo del curso, muchos de los requisitos concretos de texto, formularios, tablas, foco, navegación o componentes nacen precisamente de estos criterios.</p>\n<h3 class=\"mt-4 mb-3\">Referencias</h3>\n<ul>\n<li><a href=\"https://www.w3.org/WAI/standards-guidelines/wcag/\" target=\"_blank\" rel=\"noreferrer\">W3C: WCAG 2 Overview</a></li>\n<li><a href=\"https://www.w3.org/WAI/WCAG22/quickref/\" target=\"_blank\" rel=\"noreferrer\">W3C: How to Meet WCAG 2.2</a></li>\n<li><a href=\"https://www.w3.org/WAI/WCAG22/Understanding/intro\" target=\"_blank\" rel=\"noreferrer\">W3C: Introduction to Understanding WCAG 2.2</a></li>\n<li><a href=\"https://www.w3.org/WAI/intro/wcag10.html\" target=\"_blank\" rel=\"noreferrer\">W3C: WCAG 1.0 y su organización</a></li>\n<li><a href=\"https://www.w3.org/WAI/standards-guidelines/wcag/new-in-21/\" target=\"_blank\" rel=\"noreferrer\">W3C: What's New in WCAG 2.1</a></li>\n<li><a href=\"https://www.w3.org/WAI/standards-guidelines/wcag/new-in-22/\" target=\"_blank\" rel=\"noreferrer\">W3C: What's New in WCAG 2.2</a></li>\n</ul>"
      },
      {
        "id": "legislacion",
