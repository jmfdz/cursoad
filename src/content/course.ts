...
export const courseBlocks: Block[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        "html": "<h2 class=\"mt-4 mb-3\">Qué son las WCAG</h2>\n<p>Las WCAG (<i>Web Content Accessibility Guidelines</i>) son las pautas del W3C para hacer accesible el contenido web. Son la referencia técnica principal para revisar si una página, aplicación o documento digital cumple los requisitos de accesibilidad.</p>\n<h2 class=\"mt-4 mb-3\">Versiones</h2>\n<ul>\n<li><b>WCAG 1.0</b>: publicada en 1999. Fue la primera versión.</li>\n<li><b>WCAG 2.0</b>: publicada en 2008. Introdujo la estructura basada en principios, pautas y criterios de conformidad.</li>\n<li><b>WCAG 2.1</b>: publicada en 2018. Añadió requisitos, sobre todo en móvil, baja visión y aspectos cognitivos.</li>\n<li><b>WCAG 2.2</b>: publicada en 2023. Es la versión más reciente y la que tomamos como referencia en este curso.</li>\n</ul>\n<h2 class=\"mt-4 mb-3\">Los cuatro principios</h2>\n<p>Las WCAG 2.2 se apoyan en cuatro principios fundamentales:</p>\n<ul>\n<li><b>Perceptible</b>: la información debe poder percibirse por distintos medios. Por ejemplo, una imagen informativa necesita texto alternativo y un vídeo puede necesitar subtítulos.</li>\n<li><b>Operable</b>: la interfaz debe poder manejarse. Por ejemplo, una página debe poder usarse con teclado y no solo con ratón.</li>\n<li><b>Comprensible</b>: el contenido y el funcionamiento deben entenderse con facilidad. Por ejemplo, los formularios deben estar bien etiquetados y los errores deben explicarse con claridad.</li>\n<li><b>Robusto</b>: el contenido debe estar bien construido para que navegadores y tecnologías de apoyo puedan interpretarlo correctamente.</li>\n</ul>\n<h2 class=\"mt-4 mb-3\">Pautas</h2>\n<p>Dentro de esos principios, WCAG 2.2 agrupa <b>13 pautas</b>. Son los grandes bloques en los que se organiza la norma.</p>\n<p><b>Perceptible</b></p>\n<ul>\n<li><b>1.1 Alternativas textuales</b>: ofrecer texto equivalente para imágenes y otros elementos no textuales.</li>\n<li><b>1.2 Medios basados en el tiempo</b>: hacer accesibles vídeos, audios y multimedia.</li>\n<li><b>1.3 Adaptable</b>: estructurar el contenido para que pueda presentarse de distintas formas sin perder información.</li>\n<li><b>1.4 Distinguible</b>: facilitar que el contenido se vea y se escuche bien, por ejemplo con contraste suficiente.</li>\n</ul>\n<p><b>Operable</b></p>\n<ul>\n<li><b>2.1 Accesible por teclado</b>: permitir el uso completo sin depender del ratón.</li>\n<li><b>2.2 Tiempo suficiente</b>: dar tiempo bastante para leer, completar tareas o responder.</li>\n<li><b>2.3 Convulsiones y reacciones físicas</b>: evitar contenidos que puedan provocar reacciones físicas adversas.</li>\n<li><b>2.4 Navegable</b>: facilitar la orientación, la navegación y la localización del contenido.</li>\n<li><b>2.5 Modalidades de entrada</b>: contemplar distintas formas de interacción además del teclado clásico y el ratón.</li>\n</ul>\n<p><b>Comprensible</b></p>\n<ul>\n<li><b>3.1 Legible</b>: ayudar a que el contenido se lea y se entienda.</li>\n<li><b>3.2 Predecible</b>: hacer que la interfaz se comporte de forma esperable.</li>\n<li><b>3.3 Asistencia en la entrada de datos</b>: ayudar al usuario al rellenar formularios y corregir errores.</li>\n</ul>\n<p><b>Robusto</b></p>\n<ul>\n<li><b>4.1 Compatible</b>: asegurar que el código y los componentes puedan ser interpretados correctamente por navegadores y productos de apoyo.</li>\n</ul>\n<h2 class=\"mt-4 mb-3\">Criterios de conformidad</h2>\n<p>Lo que realmente se comprueba para determinar si una web cumple WCAG son los <b>criterios de conformidad</b>. Actualmente, en WCAG 2.2 hay <b>86 criterios</b>.</p>\n<p>Cada criterio pertenece a una pauta concreta y tiene asignado un nivel de conformidad:</p>\n<ul>\n<li><b>Nivel A</b>: criterios imprescindibles. Si no se cumplen, muchas personas no podrán acceder al contenido o completar tareas básicas.</li>\n<li><b>Nivel AA</b>: criterios que permiten acceder y usar el contenido de una forma razonablemente accesible. Es el nivel que normalmente se exige.</li>\n<li><b>Nivel AAA</b>: criterios de accesibilidad avanzada. Son útiles como mejora, pero difíciles de aplicar de forma general en todos los contenidos.</li>\n</ul>\n<p>Un ejemplo sencillo:</p>\n<ul>\n<li>Principio: <b>Perceptible</b>.</li>\n<li>Pauta: <b>1.1 Alternativas textuales</b>.</li>\n<li>Criterio: <b>1.1.1 Contenido no textual</b>.</li>\n<li>Nivel: <b>A</b>.</li>\n</ul>\n<p>Ese criterio significa, simplificando mucho, que si una imagen transmite información debe tener una alternativa textual equivalente. Si la imagen es decorativa, no necesita esa misma descripción.</p>\n<p>Cuando se dice que una web cumple <b>nivel AA</b>, lo que significa es que cumple todos los criterios de nivel A y AA que le sean aplicables.</p>\n<h3 class=\"mt-4 mb-3\">Referencias</h3>\n<ul>\n<li><a href=\"https://www.w3.org/WAI/standards-guidelines/wcag/\" target=\"_blank\" rel=\"noreferrer\">W3C: WCAG 2 Overview</a></li>\n<li><a href=\"https://www.w3.org/WAI/WCAG22/quickref/\" target=\"_blank\" rel=\"noreferrer\">W3C: How to Meet WCAG 2.2</a></li>\n<li><a href=\"https://www.w3.org/WAI/WCAG22/Understanding/intro\" target=\"_blank\" rel=\"noreferrer\">W3C: Introduction to Understanding WCAG 2.2</a></li>\n<li><a href=\"https://www.w3.org/WAI/intro/wcag10.html\" target=\"_blank\" rel=\"noreferrer\">W3C: WCAG 1.0</a></li>\n</ul>"
      },
      {
        "id": "legislacion",
